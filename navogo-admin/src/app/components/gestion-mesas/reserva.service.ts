...
export class ReservaService {
  ...
  getReservas(
    ...
    return this.http.get<{ data: Reserva[] }>(`${this.apiUrl}/reservas`, { params });
  }
  ...
  actualizar(id: number, payload: any): Observable<{ data: Reserva; message: string }> {
  ...
  cambiarEstatus(id: number, estatus: string): Observable<any> {
    return this.http.patch(`${this.apiUrl}/reservas/${id}/estatus`, { estatus });
  }
  ...
  getDisponibilidad(params: {
    ...
    return this.http.get<{ data: DisponibilidadMesa[] }>(
      `${this.apiUrl}/reservas/disponibilidad`,
      { params: p }
    );
  }
}
